...
from networkx import DiGraph, Graph, NetworkXException, planar_layout

__all__ = ["DirectionalDependencyGraph", "NetworkDependencyGraph"]


class DirectionalDependencyGraph(DiGraph):
...
class NetworkDependencyGraph(Graph):
    def layout(self, **kwargs):
        matrix = kwargs.pop("matrix", False)
        graph = kwargs.pop("graph", False)
        if matrix:
